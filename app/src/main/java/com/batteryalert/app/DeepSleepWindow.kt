...
/**
 * A daily "no alarms" window (opt-in, 23:00-07:00 preset). Pure and framework-free so
...
data class DeepSleepWindow(
    ...
    companion object {
        ...
        // Off by default: a store user must opt in to overnight silence —
        // a low-battery app that is quiet by night would surprise them.
